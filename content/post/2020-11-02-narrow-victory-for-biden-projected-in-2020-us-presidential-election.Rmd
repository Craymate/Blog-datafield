...
```{r voteg1, fig.cap="2020 Presidential Votes by Gender", echo = FALSE, fig.align='center', message = FALSE, warning=FALSE, fig.width = 5, fig.height = 3}
...
```{r voteg2, fig.cap="2020 Presidential Vote Distribution by Gender", message = FALSE, fig.align='center', echo = FALSE, warning=FALSE, fig.height = 2, fig.width = 5}
...
```{r voter1, fig.cap="2020 Presidential Votes by Race", fig.align='center', echo = FALSE, message = FALSE, warning=FALSE, fig.height = 3, fig.width = 6}
...
```{r voter2, fig.cap="2020 Presidential Vote Distribution by Race", fig.align='center', message = FALSE, echo = FALSE, warning=FALSE, fig.height = 4, fig.width = 7}
...
```{r votee1, fig.cap="2020 Presidential Votes by Education", fig.align='center', echo = FALSE, message = FALSE, warning=FALSE, fig.height = 3, fig.width = 6}
...
```{r votee2, fig.cap="2020 Presidential Vote Distribution by Education", fig.align='center', message = FALSE, echo = FALSE, warning=FALSE, fig.height = 3, fig.width = 7}
...
```{r votea1, fig.cap="2020 Presidential Votes by Age", echo = FALSE, fig.align='center', warning=FALSE, message = FALSE, fig.height = 3, fig.width = 6}
...
```{r votea2, fig.cap="2020 Presidential Vote Distribution by Age", fig.align='center', message = FALSE,echo = FALSE, warning=FALSE , fig.height = 3, fig.width = 6}
...
```{r votes1, fig.cap="2020 Presidential Votes by State", fig.align='center', echo = FALSE,message = FALSE, warning=FALSE, , fig.height = 7, fig.width = 7}
...
```{r votes2, fig.cap="2020 Presidential Vote Distribution by State", fig.align='center', message = FALSE,echo = FALSE, warning=FALSE, fig.height = 7, fig.width = 7}
...
```{r educd, echo=FALSE, message = FALSE,warning = FALSE , fig.height = 3, fig.align='center', fig.width = 3.5, fig.cap = "Distribution of Education"}
...
```{r age, echo=FALSE,message = FALSE, warning = FALSE, fig.height = 3, fig.align='center', fig.width = 3.5, fig.cap = "Distribution of Age"}
...
```{r state,message = FALSE, warning=FALSE, echo=FALSE, fig.height = 4, fig.align='center', fig.width = 6, fig.cap = "Population for Each State"}
...
```{r state1,message = FALSE, warning=FALSE, echo=FALSE, fig.height = 4, fig.align='center', fig.width = 6, fig.cap = "States Population Map"}
...
```{r gender, message = FALSE,warning = FALSE, echo=FALSE, fig.height = 3, fig.align='center', fig.width = 6,fig.cap = "Distribution of Gender"}
...
```{r race, message = FALSE,warning = FALSE, echo=FALSE, fig.height = 3, fig.align='center', fig.width = 6, fig.cap = "Population for Races"}
...
```{r popplots, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', fig.cap = "Demographic Proportions"}
...
```{r popplots1, echo = FALSE, warning = FALSE, message = FALSE, fig.align='center', fig.cap= "Proportions by State", fig.height = 5}
...
```{r bayes, echo = FALSE, message = FALSE, fig.align='center', warning = FALSE}
...
```{r bayesplot, echo = FALSE, fig.align='center', message = FALSE,warning = FALSE, fig.cap = "Comparing Survey Estimates with MRP Estimates by State",fig.width = 6, fig.height = 3}
...
```{r bayesplot1, echo = FALSE,message = FALSE, fig.align='center', warning = FALSE, fig.cap = "Comparing Survey Estimates with MRP Estimates by Age",fig.width = 6, fig.height = 3}
...
```{r bayesplot2, echo = FALSE, message = FALSE, fig.align='center',warning = FALSE, fig.cap = "Comparing Survey Estimates with MRP Estimates by Race",fig.width = 6, fig.height = 5}
...
```{r bayesplot3, echo = FALSE,message = FALSE, fig.align='center', warning = FALSE, fig.cap= "Comparing Survey Estimates with MRP Estimates by Gender",fig.width = 6, fig.height = 3}
...
```{r bayesplot4, echo = FALSE, message = FALSE, fig.align='center',warning = FALSE, fig.cap = "Comparing Survey Estimates with MRP Estimates by Education",fig.width = 6, fig.height = 3}
...
```{r appendix, message = FALSE,warning = FALSE, echo=FALSE, fig.align='center'}
