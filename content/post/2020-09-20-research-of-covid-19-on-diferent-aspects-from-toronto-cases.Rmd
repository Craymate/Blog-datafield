...
This tree-based model does not have much precision on predicting even though the testing result is good, and the outcomes are just based on  the portion between each class and total. Because this model is lack of advanced algorithms and sample data, we can only identify some variable influences by it.\
