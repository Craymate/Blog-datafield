...
The peak is in April, and started to decrease in May. There was a boost from March to April. But now it has been back to the level in March.
...
The infection between age groups is evenly distributed.
...
ggplot(fata, aes(x = `Client Gender`)) + geom_bar(stat="count") + labs(x = "Genders", y = "Number of Cases", title = "Gender Group Distribution in Fatal Cases") + theme(plot.title = element_text(hjust = 0.5))
...
Nearly half of fatal cases have ever hospitalized. And about 71% of total fatal cases got treated.
