...
```{r grid-output, warning=FALSE, message=FALSE, echo=FALSE, fig.align='center'}
...
```{r scatter, warning=FALSE, echo=FALSE, fig.align='center'}
...
```{r carte, warning=FALSE, message=FALSE, fig.align='center'}
...
```{r lm-res, echo=FALSE, fig.align='center'}
...
```{r tables, echo=FALSE, fig.align='center'}
